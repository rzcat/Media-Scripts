...
if %SubTrackNum% gtr 0 (
	set tail=(x265crop_%AudioTrackNum%Aac_%SubTrackNum%Sub.%VideoEncQ%_%AudioEncQ%.%EncSpeed%)
) else (
	set tail=(x265crop_%AudioTrackNum%Aac.%VideoEncQ%_%AudioEncQ%.%EncSpeed%)
)
